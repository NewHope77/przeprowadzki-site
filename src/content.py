...
SITE = D(
    brand="Znosimy",
    phone="+48 661 532 844",
    whatsapp="48661532844",            # bez "+" i spacji
    email="biuro@znosimy.com.pl",
    email_quote="wycena@znosimy.com.pl",
    city="Warszawa",
...
HOURLY = [
    plan("Ekonomiczny", "Auto + 1 tragarz", "190", "zł / godz.", "Ekipa 1-osobowa",
         ["Transport", "Wyniesienie i wniesienie", "Bez ukrytych kosztów", "-Zabezpieczenie folią", "-Pakowanie i montaż"], "Ekonomiczny"),
    plan("Kompleksowy", "Streczowanie · Pakowanie · Montaż", "240", "zł / godz.", "Ekipa 2-osobowa",
    ...
    plan("Standardowy", "Bez streczowania i montażu", "220", "zł / godz.", "Ekipa 2-osobowa",
...
BOX_NOTES = [
    ...
    "Kartony 5-warstwowe (60×40×40 / 45×30×30 cm) — <b>10 zł / szt.</b>",
...
SERVICES = [
    ...
    D(slug="przeprowadzki-biur", name="Przeprowadzki biur", icon="office", form="Przeprowadzka biura",
      ...
      plans=[
          plan("Mini", "Z pomocą 1 tragarza", "150", "zł / godz.", "Ekipa 1-osobowa",
               ["Transport", "Wyniesienie i wniesienie", "-Zabezpieczenie folią", "-Demontaż mebli"], "Ekonomiczny"),
          plan("Kompleksowa", "Pakowanie · Demontaż · Montaż", "240", "zł / godz.", "Ekipa 2-osobowa i więcej",
          ...
          plan("Ekonomiczna", "Bez pakowania i montażu", "220", "zł / godz.", "Ekipa 2-osobowa",
      ...
      notes=["Ceny netto. Faktura VAT dla firm (+23% VAT).", "Praca po godzinach i w soboty — do uzgodnienia.",
             "Kartony 5-warstwowe — <b>10 zł / szt.</b>, wynajem do 7 dni gratis.", "Duże biura (20+ stanowisk) — stała cena za całość po oględzinach."],
      fleet=True,
    ...
    D(slug="przeprowadzki-miedzymiastowe", name="Przeprowadzki międzymiastowe", icon="route", form="Przeprowadzka międzymiastowa",
      ...
      seo_desc="Przeprowadzki międzymiastowe z Warszawy na terenie całej Polski. Od 2 zł/km, pakowanie, montaż, ubezpieczenie do 200 000 zł.",
      ...
      badges=["Od 2 zł/km", "Cała Polska", "OCP do 200 000 zł", "Stała cena"],
      blocks=[
      ...
      plans=[
          plan("Transport krajowy", "Warszawa ⇄ cała Polska", "2", "zł / km", "Kilometry liczone w obie strony",
      ...
      notes=["Stawka za kilometr dotyczy trasy w obie strony.", "Ceny netto. Faktura VAT na życzenie (+23% VAT).",
             "Kartony 5-warstwowe — <b>10 zł / szt.</b>", "Transport zagraniczny — wycena indywidualna."],
      fleet=True,
      faq=[("Ile kosztuje przeprowadzka międzymiastowa?", "Cena zależy od odległości, ilości rzeczy, pięter załadunku i rozładunku oraz usług dodatkowych. Transport liczymy od 2 zł/km, a końcową kwotę podajemy przed wyjazdem."),
    ...
    D(slug="taxi-bagazowe", name="Taxi bagażowe", icon="box", form="Taxi bagażowe",
      ...
      h1="Szybkie taxi bagażowe <em>w Warszawie</em>",
      ...
      plans=[
          ...
          plan("Kompleksowy", "Transport · Streczowanie · Montaż", "230", "zł / godz.", "Ekipa 2-osobowa",
          ...
          plan("Ekonomiczny", "Bez streczowania i montażu", "200", "zł / godz.", "Ekipa 2-osobowa",
      ...
      fleet=True,
      faq=[("Ile kosztuje taxi bagażowe?", "Jeden mebel z wniesieniem w Warszawie to 350 zł. Większe zlecenia rozliczamy godzinowo — od 200 zł/h za auto z dwiema osobami."),
